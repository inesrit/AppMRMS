...
function HPMedicalRecords() {
    ...
    const fetchMedicalRecords = async () => {
      try {
        const userIdCookie = document.cookie
          ...
          .find(row => row.startsWith('userId='))
          .split('=')[1];
        const response = await axios.get(`https://mrms-96547282c657.herokuapp.com/api/v1/medical-record/all-user-records?userId=${userIdCookie}`, {
          withCredentials: true
        });
  ...
  const updateMedicalRecord = async (medicalrecordid, nameInput, recordTypeInput, recordResultInput) => {
    try {
      ...
      if (index !== -1) {
        ...
        await axios.put(`https://mrms-96547282c657.herokuapp.com/api/v1/medical-record/update`, updatedMedicalRecord);
  ...
  const deleteMedicalRecord = async (medicalrecordid) => {
    try {
      await axios.delete(`https://mrms-96547282c657.herokuapp.com/api/v1/medical-record/delete?medicalRecordId=${medicalrecordid}`);
