/**
 * Access page - Healthcare provider
 * 
...
function HPAccess() {
    ...
    const handleCreateAccess = async (event) => {
        ...
        try {
            ...
            const url = `https://mrms-96547282c657.herokuapp.com/api/v1/access-requests/create?userId=${userId}&patientId=${formData.selectedPatientId}`;
        ...
        const fetchAccess = async () => {
            try {
                const userIdCookie = document.cookie
                    ...
                    .find(row => row.startsWith('userId='))
                    .split('=')[1];
                const response = await axios.get(`https://mrms-96547282c657.herokuapp.com/api/v1/access-requests/all-user-requests?userId=${userIdCookie}`, {
                    withCredentials: true
                });
    ...
    useEffect(() => {
        const fetchPatients = async () => {
            try {
                ...
                const response = await axios.get(`https://mrms-96547282c657.herokuapp.com/api/v1/patient/all`, {
                    withCredentials: true
                });
