...
function Access() {
      ...
      const fetchAccess = async () => {
          try {
              const patientIdCookie = document.cookie
                  ...
                  .split('=')[1];
              const response = await axios.get(`https://mrms-96547282c657.herokuapp.com/api/v1/access-requests/all-patient-requests?patientId=${patientIdCookie}`, {
  ...
  const updateAccessStatus = async (id, status, setAccess) => {
    try {
      await axios.put(`https://mrms-96547282c657.herokuapp.com/api/v1/access-requests/update-status?requestId=${id}&status=APPROVED`);
  ...
  const updateAccessStatusToDenied = async (id, setAccess) => {
    try {
      await axios.put(`https://mrms-96547282c657.herokuapp.com/api/v1/access-requests/update-status?requestId=${id}&status=DENIED`);
  ...
  const deleteAccess = async (id) => {
    try {
      await axios.delete(`https://mrms-96547282c657.herokuapp.com/api/v1/access-requests/revoke-access?requestId=${id}`);
