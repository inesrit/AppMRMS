...
function HPPatientdashboard() {
  ...
  useEffect(() => {
    async function fetchPatientDetails() {
        try {
            const response = await axios.get(`https://mrms-96547282c657.herokuapp.com/api/v1/patient/patient-details?patientId=${patientid}`, {
  ...
  useEffect(() => {
    const fetchAppointments = async () => {
      try {
        const response = await axios.get(`https://mrms-96547282c657.herokuapp.com/api/v1/appointment/all-patient-appointments?patientId=${patientid}`, {
          withCredentials: true
        });
  ...
  useEffect(() => {
    const fetchPrescriptions = async () => {
      try {
        const response = await axios.get(`https://mrms-96547282c657.herokuapp.com/api/v1/prescription/all-patient-prescriptions?patientId=${patientid}`, {
          withCredentials: true
        });
  ...
  useEffect(() => {
    const fetchMedicalRecords = async () => {
      try {
        const response = await axios.get(`https://mrms-96547282c657.herokuapp.com/api/v1/medical-record/all-patient-records?patientId=${patientid}`, {
          withCredentials: true
        });
