...
function HPPrescriptions() {
        ...
        const fetchPatients = async () => {
            try {
                const userIdCookie = document.cookie
                    ...
                    .find(row => row.startsWith('userId='))
                    .split('=')[1];
                const response = await axios.get(`https://mrms-96547282c657.herokuapp.com/api/v1/access-requests/all-user-requests-approved?userId=${userIdCookie}`, {
                    withCredentials: true
                });
        ...
        const fetchPrescriptions = async () => {
            try {
                const userIdCookie = document.cookie
                    ...
                    .find(row => row.startsWith('userId='))
                    .split('=')[1];
                const response = await axios.get(`https://mrms-96547282c657.herokuapp.com/api/v1/prescription/all-user-prescriptions?userId=${userIdCookie}`, {
                    withCredentials: true
                });
    ...
    const updatePrescriptiontStatus = async (prescriptionid, status, setPrescriptions) => {
        try {
            await axios.put(`https://mrms-96547282c657.herokuapp.com/api/v1/prescription/update-status?prescriptionId=${prescriptionid}&status=APPROVED`);
    ...
    const updatePrescriptionStatusToDenied = async (prescriptionid, setPrescriptions) => {
        try {
            await axios.put(`https://mrms-96547282c657.herokuapp.com/api/v1/prescription/update-status?prescriptionId=${prescriptionid}&status=DENIED`);
    ...
    const updatePrescription = async (prescriptionid, nameInput, doseInput, frequencyInput, quantityInput, conditionInput) => {
        try {
            ...
            if (index !== -1) {
                ...
                await axios.put(`https://mrms-96547282c657.herokuapp.com/api/v1/prescription/update`, updatedPrescription);
    ...
    const deletePrescription = async (prescriptionid) => {
        try {
            await axios.delete(`https://mrms-96547282c657.herokuapp.com/api/v1/prescription/delete?prescriptionId=${prescriptionid}`);
